...
const translations = {
  es: {
    ...
    contextInvalidated: 'A11yGo se ha desconectado porque la extensión se recargó. Recarga la página para seguir usándola.',
  ...
  en: {
    ...
    contextInvalidated: 'A11yGo was disconnected because the extension reloaded. Reload the page to keep using it.',
